...
`)}const bh=new Nt;function wy(i){Zt._getMatrix(bh,Zt.workingColorSpace,i);const t=`mat3( ${bh.elements.map(e=>e.toFixed(4))} )`;switch(Zt.getTransfer(i)){case yo:return[t,"LinearTransferOETF"];case te:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function wh(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=(i.getShaderInfoLog(t)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return e.toUpperCase()+`
...
</svg>`;var FE=Zi('<span class="pl-3">•&nbsp;</span> ',1),OE=Zi(`<div class="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-sm shadow-xs z-10 h-8 flex items-center
