...
<svg fill="currentColor" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <rect x="0" y="0" width="36" height="36" fill-opacity="0"/>
           ...
           [-webkit-mask-size:100%_100%]"><div class="relative overflow-hidden flex-1 h-full ml-2 -mr-1"><div class="absolute whitespace-nowrap text-sm lg:text-base will-change-transform top-0 left-36 lg:left-48 h-full flex items-center"></div></div> <button class="w-7 cursor-pointer z-20"><!></button> <button class="w-8 cursor-pointer"><!></button></div>`),jT=si("<p> </p>"),QT=si('<div class="fixed inset-0 z-50 bg-black/60 flex items-center justify-center backdrop-blur-lg will-change-transform will-change-opacity" id="wiki-modal"><div class="rounded-lg px-4 md:px-20 text-[var(--textColor)] text-center overflow-y-auto py-6 max-h-[90vh]"><div class="space-y-4 text-2xl lg:text-4xl leading-9 md:leading-14 font-sans italic"></div></div></div>'),t1=si("<!> <!>",1);function e1(i,t){Xo(t,!1);const[e,n]=Yd(),r=()=>qd(yi,"$currentPage",e),s=Xn();let a=Xn(!0),o=Xn(!1),l=Xn([]),c,u=Xn();async function h(){if(!Ht(u))return;Fe.killTweensOf(Ht(u)),await Fe.delayedCall(.02,()=>{});const x=Ht(u).scrollWidth/2,v=Ht(u).parentElement?.clientWidth||0;if(x<=v){Fe.set(Ht(u),{x:0});return}Fe.set(Ht(u),{x:0}),c=Fe.to(Ht(u),{x:-x,duration:x/60,ease:"linear",repeat:-1,force3D:!0,roundProps:"x"})}wu(()=>(document.addEventListener("click",f),setTimeout(h,50),()=>{document.removeEventListener("click",f)})),j_(()=>{c&&c.kill()});function f(M){const x=window.getSelection()?.toString();Ht(o)&&M.target.closest("#wiki-modal")&&!x&&Re(o,!1)}Gs(()=>r(),()=>{Re(s,RT[r()]?.trim()||"")}),Gs(()=>Ht(s),()=>{Re(l,Ht(s)?Ht(s).split(`
`).map(M=>M.trim()):[])}),Gs(()=>(Ht(s),Ht(u),Fe),()=>{Ht(s)&&Ht(u)&&(Fe.killTweensOf(Ht(u)),h())}),Gs(()=>yi,()=>{yi||(Re(a,!1),Re(o,!1))}),Td(),Wd();var d=t1(),g=uo(d);{var _=M=>{var x=JT(),v=Vn(x),E=Vn(v);rl(E,4,()=>Array(2),il,(T,P)=>{var B=Bd(),O=uo(B);rl(O,1,()=>Ht(l),il,(W,V)=>{var z=KT(),q=$n(uo(z));Co(()=>Eh(q,` ${Ht(V)??""}`)),bn(W,z)}),bn(T,B)}),Gd(E,T=>Re(u,T),()=>Ht(u));var w=$n(v,2),A=Vn(w);Th(A,()=>ZT);var R=$n(w,2),y=Vn(R);Th(y,()=>$T),Oi("click",w,()=>Re(o,!0)),Oi("click",R,()=>Re(a,!1)),bn(M,x)};Ql(g,M=>{Ht(a)&&Ht(s)&&M(_)})}var m=$n(g,2);{var p=M=>{var x=QT(),v=Vn(x),E=Vn(v);rl(E,5,()=>Ht(l),il,(w,A)=>{var R=jT(),y=Vn(R);Co(()=>Eh(y,Ht(A))),bn(w,R)}),tc(3,v,()=>GT,()=>({y:20,duration:200})),tc(3,x,()=>Im,()=>({duration:200})),bn(M,x)};Ql(m,M=>{Ht(o)&&M(p)})}bn(i,d),qo(),n()}var n1=si('<div id="loading-overlay"><div class="loading-container"><div id="loading-bar"></div></div></div>');function i1(i){var t=n1();bn(i,t)}var r1=si('<main class="w-screen overflow-hidden h-screen text-[var(--textColor)]"><!> <!> <div id="photo-overlay-container"></div> <!> <!> <!></main>');function s1(i){var t=r1(),e=Vn(t);e1(e,{});var n=$n(e,2);YT(n);var r=$n(n,4);i1(r);var s=$n(r,2);kT(s,{});var a=$n(s,2);XT(a,{}),bn(i,t)}B_(s1,{target:document.getElementById("app")});
