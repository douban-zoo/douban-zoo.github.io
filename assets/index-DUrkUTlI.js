...
#define LOW_PRECISION`),e}function Ty(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fp?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Lg?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ri&&(e="SHADOWMAP_TYPE_VSM"),e}function by(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case gs:case vs:e="ENVMAP_TYPE_CUBE";break;case Po:e="ENVMAP_TYPE_CUBE_UV";break}return e}function wy(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case vs:e="ENVMAP_MODE_REFRACTION";break}return e}function Ay(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case hp:e="ENVMAP_BLENDING_MULTIPLY";break;case jg:e="ENVMAP_BLENDING_MIX";break;case Jg:e="ENVMAP_BLENDING_ADD";break}return e}function Ry(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Cy(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Ty(t),c=by(t),u=wy(t),f=Ay(t),h=Ry(t),d=_y(t),g=gy(s),_=r.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
"><div class="relative w-11/12 max-w-3xl overflow-hidden"><button class="
    ...
    ">&times;</button> <video class="w-[80%] lg:w-[60%] mt-2 h-auto block mx-auto rounded-xl" playsinline="" loop autoplay></video></div></div>`,2);function mE(i){var e=pE();ai(i,e)}const _E=i=>i;function gE(i){const e=i-1;return e*e*e+1}function Eh(i){const e=typeof i=="string"&&i.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return e?[parseFloat(e[1]),e[2]||"px"]:[i,"px"]}function vE(i,{delay:e=0,duration:t=400,easing:n=_E}={}){const r=+getComputedStyle(i).opacity;return{delay:e,duration:t,easing:n,css:s=>`opacity: ${s*r}`}}function xE(i,{delay:e=0,duration:t=400,easing:n=gE,x:r=0,y:s=0,opacity:a=0}={}){const o=getComputedStyle(i),l=+o.opacity,c=o.transform==="none"?"":o.transform,u=l*(1-a),[f,h]=Eh(r),[d,g]=Eh(s);return{delay:e,duration:t,easing:n,css:(_,m)=>`
			transform: ${c} translate(${(1-_)*f}${h}, ${(1-_)*d}${g});
			opacity: ${l-u*m}`}}const ME=`<svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`;var yE=qi('<span class="pl-3">•&nbsp;</span> ',1),EE=qi('<div class="fixed top-0 left-0 w-full text-[var(--textColor)] bg-white/70 backdrop-blur-sm shadow-xs z-10 h-8 flex items-center"><button class="pl-1 w-9 cursor-pointer"><!></button> <div class="relative overflow-hidden flex-1 h-full"><div class="absolute whitespace-nowrap text-sm lg:text-base will-change-transform top-0 left-12 h-full flex items-center"></div></div> <button class="pr-1 w-8 cursor-pointer"><!></button></div>'),TE=qi("<p> </p>"),bE=qi('<div class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-lg" id="wiki-modal"><div class="rounded-lg px-4 md:px-20 text-[var(--textColor)] text-center overflow-y-auto py-6 max-h-[90vh]"><div class="space-y-4 text-2xl lg:text-4xl leading-9 md:leading-14 font-sans italic"></div></div></div>'),wE=qi("<!> <!>",1);function AE(i,e){Gc(e,!1);const[t,n]=c_(),r=()=>l_(Jr,"$currentPage",t),s=li();let a=li(!0),o=li(!1),l=li([]),c,u=li();async function f(){if(!Ie(u))return;Jt.killTweensOf(Ie(u)),await Jt.delayedCall(.02,()=>{});const S=Ie(u).scrollWidth/2,v=Ie(u).parentElement?.clientWidth||0;if(S<=v){Jt.set(Ie(u),{x:0});return}Jt.set(Ie(u),{x:0}),c=Jt.to(Ie(u),{x:-S,duration:S/60,ease:"linear",repeat:-1,force3D:!0,roundProps:"x"})}eu(()=>{setTimeout(f,50)}),u_(()=>{c&&c.kill()});function h(y){Ie(o)&&y.target.closest("#wiki-modal")&&Ot(o,!1)}document.addEventListener("click",h),Fo(()=>r(),()=>{Ot(s,aE[r()]?.trim()||"")}),Fo(()=>Ie(s),()=>{Ot(l,Ie(s)?Ie(s).split(`
`).map(y=>y.trim()):[])}),Fo(()=>(Ie(s),Ie(u),Jt),()=>{Ie(s)&&Ie(u)&&(Jt.killTweensOf(Ie(u)),f())}),Um(),ud();var d=wE(),g=No(d);{var _=y=>{var S=EE(),v=Ri(S),T=Ri(v);ju(T,()=>ME);var w=$r(v,2),A=Ri(w);Bo(A,4,()=>Array(2),Oo,(b,P)=>{var B=qm(),O=No(B);Bo(O,1,()=>Ie(l),Oo,(G,W)=>{var V=yE(),Y=$r(No(V));oo(()=>Zu(Y,` ${Ie(W)??""}`)),ai(G,V)}),ai(b,B)}),cd(A,b=>Ot(u,b),()=>Ie(u));var C=$r(w,2),x=Ri(C);ju(x,()=>SE),Ci("click",v,()=>Ot(o,!0)),Ci("click",C,()=>Ot(a,!1)),ai(y,S)};Ku(g,y=>{Ie(a)&&Ie(s)&&y(_)})}var m=$r(g,2);{var p=y=>{var S=bE(),v=Ri(S),T=Ri(v);Bo(T,5,()=>Ie(l),Oo,(w,A)=>{var C=TE(),x=Ri(C);oo(()=>Zu(x,Ie(A))),ai(w,C)}),ef(3,v,()=>xE,()=>({y:20,duration:300})),ef(3,S,()=>vE,()=>({duration:150})),ai(y,S)};Ku(m,y=>{Ie(o)&&y(p)})}ai(i,d),Wc(),n()}var RE=qi('<main class="w-screen overflow-hidden h-screen"><!> <!> <div id="photo-overlay-container"></div> <!></main>');function CE(i){var e=RE(),t=Ri(e);AE(t,{});var n=$r(t,2);mE(n);var r=$r(n,4);dE(r,{}),ai(i,e)}Ym(CE,{target:document.getElementById("app")});
